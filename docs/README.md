...
- `scripts/docs/ppt-text-normalize.md` 记录当前内置 `ppt_text_normalize` Safe MVP 与可选 visual review gate 的命令面和安全边界。
- `ppt_text_normalize` 的 Safe MVP 内核仍是 `scan` / `apply`；visual review gate 是介于两者之间的可选人工审核层。
