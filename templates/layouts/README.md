...
| `sustech_academic_official` | Scenario | Academic reports, course reports, thesis defenses, and lab sharing | SUSTech Orange/Cyan `#B63742` `#E3660D` `#01ABA8` `#003F43` | Official academic, restrained, school-branded |
...
| `sustech_academic_official` | SUSTech official academic template, derived from the university master style for course reports, research briefings, thesis defenses, and lab sharing |
...
### sustech_academic_official — Card color policy

For the `sustech_academic_official` template, card colors should follow these rules:

- Deep teal `#003F43` is primarily for **page / TOC / chapter / structural titles** and **limited hero emphasis**.
- Inside `content_area`, ordinary cards should prefer:
  - **white fill + gray border**
  - **light cyan fill**
  - **light warm / orange fill**
- For **parallel / same-level cards**, prefer either:
  - light cyan + light warm mixed pairing, or
  - a unified set of white-outline cards, or
  - a unified set of one light surface family.
- Avoid using deep teal as the default background for ordinary parallel information cards.
- Body copy inside cards should primarily use dark text, with orange reserved for accent / emphasis rather than long text blocks.
