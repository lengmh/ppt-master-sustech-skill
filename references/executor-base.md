...
- **Card containers — reuse the existing chart-library structures**: when a content page needs section cards (4 quadrants, parallel aspects, capability blocks, info cards), start from the reusable patterns already present in [`templates/charts/README.md`](../templates/charts/README.md) and the existing SVG examples [`kpi_cards.svg`](../templates/charts/kpi_cards.svg), [`matrix_2x2.svg`](../templates/charts/matrix_2x2.svg), [`comparison_columns.svg`](../templates/charts/comparison_columns.svg), [`vertical_list.svg`](../templates/charts/vertical_list.svg), [`process_flow.svg`](../templates/charts/process_flow.svg), and [`org_chart.svg`](../templates/charts/org_chart.svg). Do not reinvent the "tinted full-rounded rect + white cover-rect to hide the bottom corners" hack; it survives in older templates but breaks SVG→PPTX color editing.
